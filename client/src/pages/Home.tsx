      ...
      <div className="flex justify-center overflow-hidden rounded-lg">
        <div className="w-full max-w-4xl">
          <div className="relative w-full h-[520px] flex items-center justify-center group">
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 cursor-pointer bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all w-10 h-10 flex items-center justify-center text-xl"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-20 cursor-pointer bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all w-10 h-10 flex items-center justify-center text-xl"
